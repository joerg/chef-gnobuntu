...
%w( launchpad-integration software-center jockey-gtk rhythmbox-ubuntuone ubuntuone-client-gnome ubuntuone-control-panel-gtk whoopsie deja-dup overlay-scrollbar ).each do |p|
  package p do
